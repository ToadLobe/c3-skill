...
Update a [team](https://www.construct.net/game-services/manuals/game-services/leaderboards/api-objects/team).
...
```none
https://leaderboards.construct.net/updateteam.json
```
...
```json
{
  ...
  "helpURL": "https://www.construct.net/en/game-services/manuals/game-services/leaderboards/api-end-points/teams/update-team",
  "shouldRetry": false
}
```
