...
```none
https://leaderboards.construct.net/assignteamplayer.json
```
...
The ID of the team you're adding a player to.

**playerID guid Required**
The ID of the player you're adding to the team.
...
```none
{
  ...
  "helpURL": "https://www.construct.net/en/game-services/manuals/game-services/leaderboards/api-end-points/teams/assign-player",
  "shouldRetry": false
}
```
