...
```none
https://leaderboards.construct.net/deleteteamplayer.json
```
...
The ID of the leaderboard the team exists on.

**teamID guid Required**
The ID of the team you're removing a player from.

**playerID guid Required**
The ID of the player you're removing from the team.
...
```none
{
  ...
  "helpURL": "https://www.construct.net/en/game-services/manuals/game-services/leaderboards/api-end-points/teams/remove-player",
  "shouldRetry": false
}
```
