...
Adjusts the score value of an existing [score](https://www.construct.net/game-services/manuals/game-services/leaderboards/api-objects/score) in the leaderboard. You can pass a positive value to increase the value of the score, or a negative value to decrease it.  A leaderboard must permit score adjustments in it's settings otherwise calls to adjust scores will fail.
