...
This end point allows players to rate [cloud save blobs](https://www.construct.net/game-services/manuals/game-services/cloud-save/api-objects/blob).  You can [create rating dimensions](https://www.construct.net/game-services/manuals/game-services/cloud-save/api-end-points/ratings/create-dimension) to allow players to vote on different aspects of cloud saves.
