...
This end point allows you to delete an existing [rating dimension](https://www.construct.net/game-services/manuals/game-services/ratings/api-objects/rating-dimension-object) for a [game bucket](https://www.construct.net/game-services/manuals/game-services/cloud-save/api-objects/game-buckets).
...
The ID of the [game bucket](https://www.construct.net/game-services/manuals/game-services/cloud-save/api-objects/game-buckets) you're deleting a rating dimension on.
