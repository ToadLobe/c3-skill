...
This end point allows you to update properties on an existing [rating dimension](https://www.construct.net/game-services/manuals/game-services/ratings/api-objects/rating-dimension-object) setup on a [game bucket](https://www.construct.net/game-services/manuals/game-services/cloud-save/api-objects/game-buckets).
