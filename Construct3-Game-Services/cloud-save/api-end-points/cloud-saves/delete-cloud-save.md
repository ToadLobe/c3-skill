...
If authenticating this request as a player, the authorised player can always delete blobs they've uploaded in their own player storage or a [game bucket](../../../cloud-save/api-objects/game-buckets.md).  Players cannot delete other players blobs.  If authenticating with your game's secret key, you can delete any blob.
