...
This end point allows you to delete an existing [bucket](../../../{Replacements.CloudSaves.Objects.Bucket%257.md).  Deleting a bucket will also delete all the [cloud save blobs](../../../{Replacements.CloudSaves.Objects.Blob%257.md) in the bucket.  Deletion is irreversible and permanent.
...
**bucketID** `[guid](../../../data-types#internalH1Link1.md)` *Required*
