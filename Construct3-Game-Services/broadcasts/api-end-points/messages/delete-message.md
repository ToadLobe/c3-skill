...
This end point allows you to delete an existing [message](https://www.construct.net/game-services/manuals/game-services/broadcasts/api-objects/broadcast-message).  Deletions are irreversible and permanent.
