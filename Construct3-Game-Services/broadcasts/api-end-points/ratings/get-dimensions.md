...
This end point allows you to retrieve all existing [rating dimensions](../../../ratings/api-objects/rating-dimension-object.md) current setup on a [channel](../../../broadcasts/api-objects/broadcast-channel.md).
...
The ID of the [channel](../../../broadcasts/api-objects/broadcast-channel.md) you're fetching [rating dimensions](../../../ratings/api-objects/rating-dimension-object.md) from.
