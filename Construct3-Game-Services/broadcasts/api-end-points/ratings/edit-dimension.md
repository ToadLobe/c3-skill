...
source: "https://www.construct.net/en/game-services/manuals/game-services/broadcasts/api-end-points/ratings/edit-dimension"
release: 476.3
---
...
```none
https://broadcasts.construct.net/channeleditratingdimension.json
```
...
```json
{
  ...
  "helpURL": "https://www.construct.net/en/game-services/manuals/game-services/broadcasts/api-end-points/ratings/edit-dimension",
  "shouldRetry": false
}
```
