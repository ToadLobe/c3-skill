...
This end point allows players to rate [messages](../../../broadcasts/api-objects/broadcast-message.md).  You can [create rating dimensions](../../../broadcasts/api-end-points/ratings/create-dimension.md) to allow players to vote on different aspects of this message - although the most common scenario for rating a broadcast message is a yes/no rating to represent likes and dislikes.
