...
This end point allows you to retrieve all [messages](https://www.construct.net/game-services/manuals/game-services/broadcasts/api-objects/broadcast-message) in a specified [broadcast channel](https://www.construct.net/game-services/manuals/game-services/broadcasts/api-objects/broadcast-channel).  Messages are returned newest first.
