...
- [Overview](#supported-culture-codes)
- [Supported Culture Codes](#internalH1Link1)
...
Below is a comprehensive list of supported culture codes along with their English represented name.
...
bgc = Haryanvi
bgc-Deva = Haryanvi (Devanagari)
bgc-Deva-IN = Haryanvi (Devanagari, India)
bho = Bhojpuri
bho-Deva = Bhojpuri (Devanagari)
bho-Deva-IN = Bhojpuri (Devanagari, India)
bin = Edo
bin-NG = Edo (Nigeria)
bm = Bamanankan
...
cv = Chuvash
cv-Cyrl = Chuvash (Cyrillic)
cv-Cyrl-RU = Chuvash (Cyrillic, Russia)
cy = Welsh
...
doi-Deva-IN = Dogri (Devanagari, India)
dsb = Lower Sorbian
...
kgp = Kaingang
kgp-Latn = Kaingang (Latin)
kgp-Latn-BR = Kaingang (Latin, Brazil)
khq = Koyra Chiini
...
pcm = Nigerian Pidgin
pcm-Latn = Nigerian Pidgin (Latin)
pcm-Latn-NG = Nigerian Pidgin (Latin, Nigeria)
pl = Polish
pl-PL = Polish (Poland)
prg = Prussian
...
quc = Kʼicheʼ
quc-Latn = Kʼicheʼ (Latin)
quc-Latn-GT = Kʼicheʼ (Latin, Guatemala)
quz = Quechua
...
raj-Deva-IN = Rajasthani (Devanagari, India)
rm = Romansh
...
sc = Sardinian
sc-Latn = Sardinian (Latin)
sc-Latn-IT = Sardinian (Latin, Italy)
sd = Sindhi
sd-Arab = Sindhi
...
yrl = Nheengatu
yrl-Latn = Nheengatu (Latin)
yrl-Latn-BR = Nheengatu (Latin, Brazil)
yrl-Latn-CO = Nheengatu (Latin, Colombia)
yrl-Latn-VE = Nheengatu (Latin, Venezuela)
