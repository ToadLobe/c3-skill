...
This end point allows you to delete an existing [XP bonus](https://www.construct.net/game-services/manuals/game-services/xp/api-objects/bonus-object).  This action cannot be reversed.
...
```none
https://xp.construct.net/deletebonus.json
```
...
The ID of the bonus you want to delete.
...
```json
{
  ...
  "helpURL": "https://www.construct.net/en/game-services/manuals/game-services/xp/api-end-points/bonuses/delete-bonus",
  "shouldRetry": false
}
```
