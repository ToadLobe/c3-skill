---
title: "Add XP"
source: "https://www.construct.net/en/game-services/manuals/game-services/xp/api-end-points/xp/add-xp"
release: 476.3
---
...
This end point allows you to add XP to a player.  The XP awarded is automatically multiplied with any active bonuses.
...
```none
https://xp.construct.net/addxp.json
```
...
```json
{
  ...
  "helpURL": "https://www.construct.net/en/game-services/manuals/game-services/xp/api-end-points/xp/add-xp",
  "shouldRetry": false
}
```
