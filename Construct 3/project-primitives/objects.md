...
When inserting a new object, typically you first choose the [plugin](https://www.construct.net/make-games/manuals/construct-3/project-primitives/objects/plugins) in the dialog (e.g. *Sprite*). This then creates an [object type](https://www.construct.net/make-games/manuals/construct-3/project-primitives/objects/object-types) (e.g. *TrollEnemy*). When the mouse turns to a crosshair this allows you to place the first *instance*, and you can duplicate the instance to create more of them.
