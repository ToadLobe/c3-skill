...
---
The **Layers Bar** is used to add, edit and remove [layers](https://www.construct.net/make-games/manuals/construct-3/project-primitives/layers) in a [layout](https://www.construct.net/make-games/manuals/construct-3/project-primitives/layouts). A layer is like a sheet of glass objects are painted on to. This allows easy arrangement of which objects display in front of other objects, for example showing foreground objects in front of the background sprites. It also allows for interesting depth effects like Z elevation or parallax, and layers can be individually scaled and rotated as well.
...
Selecting a layer displays its properties in the [Properties Bar](https://www.construct.net/make-games/manuals/construct-3/interface/bars/properties-bar) and also sets it as the **active layer** which new objects are inserted in to.
...
- An optional **tag icon** to denote [HTML layers](https://www.construct.net/make-games/manuals/construct-3/tips-and-guides/html-layers).
...
## Object Z ordering
To modify the Z order (front-to-back order) of individual objects on a layer, use the [Z Order Bar](https://www.construct.net/make-games/manuals/construct-3/interface/bars/z-order-bar)  `[Paid plans only]` .
