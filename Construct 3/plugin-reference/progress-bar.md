...
- [Progress bar properties](#internalH1Link1)
- [Progress bar conditions](#internalH1Link2)
- [Progress bar actions](#internalH1Link3)
- [Progress bar expressions](#internalH1Link4)

---
The **Progress bar** object displays a bar which can be used to indicate the progress of a long-running operation or goal.

![A progress bar](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/1018/progressbar.png)
