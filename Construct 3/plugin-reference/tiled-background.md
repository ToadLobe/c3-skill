...
## On this page
- [Tile randomization](#internalH1Link0)
- [Tiled Background properties](#internalH1Link1)
- [Tiled Background conditions](#internalH1Link2)
- [Tiled Background actions](#internalH1Link3)
- [Tiled Background expressions](#internalH1Link4)

---
The **Tiled Background** object can display an image in a repeating pattern, as shown below.

![A Tiled Background object](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/986/tiled-background.png)
...
![Left: standard tiling. Right: randomized tiling.](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/92710/tile-randomization.jpg)
