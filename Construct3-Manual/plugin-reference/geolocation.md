...
- [Permission prompts](#scripting)
- [Battery usage](#permission-prompts)
- [Geolocation conditions](#battery-usage)
- [Geolocation actions](#geolocation-conditions)
- [Geolocation expressions](#geolocation-actions)
