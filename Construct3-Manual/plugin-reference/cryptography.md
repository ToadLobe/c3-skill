...
## On this page
- [Encryption does not guarantee security](#internalH1Link0)
- [HTTPS is already encrypted](#internalH1Link1)
- [Processing text](#internalH1Link2)
- [Examples](#internalH1Link3)
- [Encrypted data format](#internalH1Link4)
- [Cryptography conditions](#internalH1Link5)
- [Cryptography actions](#internalH1Link6)
- [Cryptography expressions](#internalH1Link7)
