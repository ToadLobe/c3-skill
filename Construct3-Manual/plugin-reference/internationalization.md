...
## On this page
- [Locales](#internalH1Link0)
- [The translation file](#internalH1Link1)
- [Loading an Internationalization file](#internalH1Link2)
- [Looking up localized strings](#internalH1Link3)
- [Nesting, Push and Pop](#internalH1Link4)
- [Substitutions](#internalH1Link5)
- [Plural rules](#internalH1Link6)
- [Internationalization conditions](#internalH1Link7)
- [Internationalization actions](#internalH1Link8)
- [Internationalization expressions](#internalH1Link9)
...
```
Copy A language file is a JSON file, with two distinct keys.
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104057/internationalizationmanual01.png)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104066/internationalizationmanual02.png)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104067/internationalizationmanual03.png)
...
```
Copy The string has two placeholders that can be replaced at runtime if additional values are provided when using the *Lookup* expression. There can be any amount of placeholders and the number in between the curly braces refers to the order of the arguments passed to *Lookup*.

**Example 1**

![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104097/internationalizationmanual04.png)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104098/internationalizationmanual05.png)
...
```
Copy In order to look up the plural form the *LookupPlural* expression is used passing in an additional value which is used to decide which plural form will be used. 
**Example 1**

![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104099/internationalizationmanual06.png)

That example would yield the string **"1 Pig"**.

**Example 2**

![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/104100/internationalizationmanual07.png)
