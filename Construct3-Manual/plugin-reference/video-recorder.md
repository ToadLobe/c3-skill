...
## On this page
- [Video recorder conditions](#internalH1Link0)
- [Video recorder actions](#internalH1Link1)
- [Video recorder expressions](#internalH1Link2)
...
Start recording video and/or audio from a [User Media](https://www.construct.net/en/make-games/manuals/construct-3/plugin-reference/user-media) object's input. *On media request approved* must trigger before this can be used.
