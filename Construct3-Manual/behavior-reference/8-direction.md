...
## On this page
- [8 Direction properties](#internalH1Link0)
- [8 Direction conditions](#internalH1Link1)
- [8 Direction actions](#internalH1Link2)
- [8 Direction expressions](#internalH1Link3)
...
The 8 Direction behavior is blocked by any objects with the [Solid behavior](solid.md).
