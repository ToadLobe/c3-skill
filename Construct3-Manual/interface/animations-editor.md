...
## On this page
- [Color palette](#internalH1Link0)
- [Top toolbar: image tools](#internalH1Link1)
- [Side toolbar: drawing tools](#internalH1Link2)
- [Frames pane](#internalH1Link3)
- [Animations and properties panes](#internalH1Link4)
- [Image points pane](#internalH1Link5)
- [Drag-and-drop](#internalH1Link6)
- [Bulk importing](#internalH1Link7)
- [Color palette file format](#internalH1Link8)
- [Miscellaneous settings](#internalH1Link9)
...
To open this editor, **double-click** an object with an image or animations in the [Layout View](https://www.construct.net/make-games/manuals/construct-3/interface/layout-view) or [Project Bar](https://www.construct.net/make-games/manuals/construct-3/interface/bars/project-bar).

![The Animations Editor](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/139536/animations-editor.png)
...
### Saving a palette
Right clicking anywhere in the area where swatches of the color palette are will bring up a context menu with the option `Save palette`, click it to save the palette and be able to retrieve it later. Saved palettes are associated with the [object type](https://www.construct.net/en/make-games/manuals/construct-3/project-primitives/objects/object-types) or [project file](https://www.construct.net/en/make-games/manuals/construct-3/project-primitives/files) that is currently being edited, but can be used on other object types or project files.
...
Any of those methods will bring up a dialog from which any of the palettes stored in the [project](https://www.construct.net/en/make-games/manuals/construct-3/project-primitives/projects) can be picked.
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/6978/imgpts.png)
...
```
Copy ### Configuration file options
...
```
Copy when sorted in ***"alphabetical"*** and ***"ascending"*** order will end up like this 
```javascript
...
```
Copy when sorted in ***"numerical"*** and ***"ascending"*** order will end up like this 
```javascript
"1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png", "8.png", "9.png", "10.png"
```
Copy #### Example 4
...
```
Copy ### Color palette file properties
