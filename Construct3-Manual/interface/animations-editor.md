...
- [Top toolbar: image tools](#saving-a-palette)
- [Side toolbar: drawing tools](#picking-a-palette)
...
When the textures of [3D model plugin instance](../plugin-reference/3d-model.md), all the textures for each mesh appear in the Frames pane.
