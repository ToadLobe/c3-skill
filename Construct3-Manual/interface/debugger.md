...
The debugger works much like an [ordinary preview](../overview/testing-and-publishing.md), except that an extra panel appears alongside the project showing lots of information and some diagnostic tools.
