...
- [Main debugger commands](#customising-the-debugger-panel)
- [Performance summary](#main-debugger-commands)
- [Breakpoints](#performance-summary)
...
The debugger has three tabs: [Inspect](https://www.construct.net/make-games/manuals/construct-3/interface/debugger/inspect-tab), [Watch](https://www.construct.net/make-games/manuals/construct-3/interface/debugger/watch-tab)  `[Paid plans only]` , [CPU Profiler](https://www.construct.net/make-games/manuals/construct-3/interface/debugger/profile-tab)  `[Paid plans only]`  and [GPU Profiler](../interface/debugger/gpu-profile-tab.md)  `[Paid plans only]` . For more information, see the manual entries for each.

## Running the debugger

The debugger appears when you choose the *Debug* preview mode. This can be reached via the [main toolbar](https://www.construct.net/make-games/manuals/construct-3/interface/main-toolbar), the [main menu](https://www.construct.net/make-games/manuals/construct-3/interface/main-menu), the [Project Bar](https://www.construct.net/) or using the keyboard shortcut <kbd>Ctrl</kbd> + <kbd>F5</kbd>.

The debugger works much like an [ordinary preview](https://www.construct.net/make-games/manuals/construct-3/overview/testing-and-publishing), except that an extra panel appears alongside the project showing lots of information and some diagnostic tools.

[![The debugger showing information about the running project](https://construct-static.com/images/v1740/r/uploads/articleuploadobject/0/images/81866/debugger-ui_v800.png)](https://construct-static.com/images/v1740/uploads/articleuploadobject/0/images/81866/debugger-ui.png)The debugger showing information about the running project
...
Some details about the performance of the project appear in the debugger's main title bar, and in the *Inspect* tab area for the System object, which is displayed initially. For more advice on performance, see [Performance Tips](https://www.construct.net/make-games/manuals/construct-3/tips-and-guides/performance-tips). Note that since the debugger displays and manages a lot of information, it can have a significant performance overhead itself; when measuring performance, it's best to switch to one of the Profiler tabs  `[Paid plans only]` , or use the normal preview mode and display performance measurements with objects. The performance information the debugger displays includes the following:
...
When running the debugger, it's possible to set *breakpoints* to pause execution of an event sheet on a specific event, condition or action. For more information, see the manual entry on [breakpoints](https://www.construct.net/make-games/manuals/construct-3/project-primitives/events/breakpoints).
