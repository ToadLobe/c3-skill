---
title: "Bars"
source: "https://www.construct.net/en/make-games/manuals/construct-3/interface/bars"
release: 476.3
---

## On this page

- [Opening separate windows](#opening-separate-windows)

---

In Construct, many features appear in **Bars**. These are the panes that appear at the sides of the window by default.

Note that bars work differently on mobile devices. See [Construct on mobile](https://www.construct.net/make-games/manuals/construct-3/getting-started/on-mobile) for more information.
...
You can reset the layout of the bars by clicking the **Reset bars & dialogs** button in [Settings](https://www.construct.net/make-games/manuals/construct-3/interface/dialogs/settings) and then reloading Construct.
