...
Note that bars work differently on mobile devices. See [Construct on mobile](../getting-started/on-mobile.md) for more information.
...
You can reset the layout of the bars by clicking the **Reset bars & dialogs** button in [Settings](dialogs/settings.md) and then reloading Construct.
