...
## On this page
- [The Z Order list](#internalH1Link0)
- [Identifying instances](#internalH1Link1)
- [Editing the Z Order](#internalH1Link2)
- [View options](#internalH1Link3)
...
![The Z Order Bar](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/878/z-order-bar.png)
...
## View options
You can right-click the Z Order Bar and select `Show active layer only`. This further filters down the list to only display objects on the current active layer (the selected layer in the [Layers Bar](https://www.construct.net/en/make-games/manuals/construct-3/interface/bars/layers-bar)), which can be useful when working with a single layer.
