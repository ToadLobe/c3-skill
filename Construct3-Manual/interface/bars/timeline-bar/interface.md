...
- **[Timeline folder](../../../project-primitives/timelines/timeline-folder.md):** Represented as a row with an icon of a folder. These are used to organize nested timelines in a parent timeline. Timeline folders can only exist as children of the main timeline or nested inside other timeline folders.
