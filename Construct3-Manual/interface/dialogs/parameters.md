...
The parameters that are displayed depend on the condition or action that was selected. To find out more about what to enter for each field, check the related documentation in the [Plugin reference](https://www.construct.net/en/make-games/manuals/construct-3/plugin-reference), [Behavior reference](https://www.construct.net/en/make-games/manuals/construct-3/behavior-reference) or [System reference](https://www.construct.net/en/make-games/manuals/construct-3/system-reference).
...
![The Parameters dialog](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/963/parameters-dialog.png)
...
![Autocomplete in the Parameters dialog](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/964/autocomplete.png)
...
![Tips for expression parameters in the Parameters dialog](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/965/calltips.png)
