...
Set the *Fullscreen quality* [project property](../project-primitives/projects.md). This allows the quality setting to be adjusted at runtime.

**Set pixel rounding**  
Set the *Pixel rounding* [project property](../project-primitives/projects.md) at runtime.
...
**Stop loop**  
Stop a *Repeat*, *For* or *For each* loop currently running. These loops are [system conditions](system-conditions.md). The rest of the event's actions and subevents will still complete, but the loop will not run any further after that.
