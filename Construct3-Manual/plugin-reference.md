...
Many plugins share common actions, conditions and expressions. These are described in [Common features](plugin-reference/common-features.md) rather than repeating the information for each plugin.
