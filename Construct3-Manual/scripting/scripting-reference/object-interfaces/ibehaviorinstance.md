...
Many behaviors return a more specific class deriving from IBehaviorInstance to add APIs specific to the behavior. See the [Behavior instances reference](../behavior-interfaces/tween.md) for more information.
