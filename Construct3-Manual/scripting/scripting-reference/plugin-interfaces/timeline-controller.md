...
# Timeline controller script interface

## On this page
- [Timeline controller APIs](#internalH1Link0)

---
The `ITimelineControllerObjectType` interface derives from [IObjectClass](https://www.construct.net/en/make-games/manuals/construct-3/scripting/scripting-reference/object-interfaces/iobjectclass) to add APIs specific to the [Timeline Controller plugin](https://www.construct.net/make-games/manuals/construct-3/plugin-reference/timeline-controller).
