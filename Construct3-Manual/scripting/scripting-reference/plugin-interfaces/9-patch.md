...
The `I9PatchInstance` interface derives from [IWorldInstance](../object-interfaces/iworldinstance.md) to add APIs specific to the [9-patch plugin](../../../plugin-reference/9-patch.md).
