...
## On this page
- [Adding an import map](#internalH1Link0)
- [Why to use import maps](#internalH1Link1)
- [Limitations](#internalH1Link2)
...
```
Copy However with an import map you can write something like this instead:
```javascript
// Standard path-based import
import * as MyModule from "mymodule";
```
Copy The import map then determines what path to use for "mymodule".
...
```
Copy Now if you write this in a script file:
```javascript
// Standard path-based import
import * as MyModule from "mymodule";
```
Copy ...the import map means that importing "mymodule" will load the path "./mymodule-v1.js".
