...
## On this page
- [Scripts in actions](#internalH1Link0)
- [Scripts in blocks](#internalH1Link1)
- [Using 'await'](#internalH1Link2)
- [Using imports](#internalH1Link3)
- [Using the runtime interface](#internalH1Link4)
- [Accessing local variables](#internalH1Link5)
- [Errors](#internalH1Link6)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/132043/add-action-script.png)
...
```
Copy ...then all your JavaScript code in script actions and script blocks can use the exports in *Utils*, e.g. `Utils.myExport()`. This provides a useful way to write a library of functions that can be used by code anywhere else in the project, and is another good way to closely integrate event sheets with code.
...
```
Copy ## Accessing local variables
