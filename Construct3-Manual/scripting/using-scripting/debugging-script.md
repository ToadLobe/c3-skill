...
## On this page
- [Debugging TypeScript](#internalH1Link0)
- [Construct's debugger](#internalH1Link1)
- [Opening dev tools](#internalH1Link2)
- [The console](#internalH1Link3)
- [Debugging JavaScript code](#internalH1Link4)
- [More tools and techniques](#internalH1Link5)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/139574/dev-tools-sources.png)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/132048/console-to-debugger.png)
...
![](https://construct-static.com/images/v1721/uploads/articleuploadobject/0/images/132050/debugger-code-breakpoint.png)
...
debugger;
```
Copy Whenever this line of code runs, the debugger will automatically stop as if there was a breakpoint on that line. However it will always do this until you delete the statement from your code, whereas normal breakpoints can be removed at any time.
