...
**Size**  
The width and height of the instance in pixels. This can also be altered by dragging the resize handles in the Layout View. For 3D objects like [3D shape](https://www.construct.net/make-games/manuals/construct-3/plugin-reference/3d-shape/edit), a third depth component will appear here.
