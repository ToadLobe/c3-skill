...
These are used to organize elements in a [timeline](timeline.md), and don't have any impact in the playback. A track folder can have nested [tracks](track.md) as well as other track folders. They can be moved to and from track folders or the root of the timeline by dragging and dropping.
...
**Visible**
See the section on common timeline element properties in [Timelines](../timelines.md). Changing these at the track folder level will apply the change to every sub-element.
