...
When inserting a new object, typically you first choose the [plugin](objects/plugins.md) in the dialog (e.g. *Sprite*). This then creates an [object type](objects/object-types.md) (e.g. *TrollEnemy*). When the mouse turns to a crosshair this allows you to place the first *instance*, and you can duplicate the instance to create more of them.
