...
When developing an effect addon, additional information about the effect is included in the addon.json file. For more information see [Configuring effects](configuring-effects.md).
