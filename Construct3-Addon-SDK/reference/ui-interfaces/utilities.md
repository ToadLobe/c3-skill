...
- `layoutView`: an [ILayoutView](ilayoutview.md) interface representing the Layout View that was open when the file was dropped. This also provides access to the associated project, layout, current active layer, and so on.
